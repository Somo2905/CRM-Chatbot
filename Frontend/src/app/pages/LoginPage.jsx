      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-auto">
            <h2 className="text-4xl font-bold text-white mb-4">
              Welcome to the Future of<br />Automotive Retail
            </h2>
            <p className="text-blue-100 text-lg">
              Streamline your dealership operations with AI-powered conversations and intelligent automation.
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10 flex gap-8 text-white">
          ...
          <div>
            ...
            <div className="text-blue-100 text-sm">AI Support</div>
          </div>
          <div>
            <div className="text-3xl font-bold mb-1">500+</div>
            <div className="text-blue-100 text-sm">Dealerships</div>
          </div>
        </div>
      </div>
